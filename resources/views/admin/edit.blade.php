                  ...
                  <div class="col-sm-12 col-lg-12">
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                            ...
                            <form method="post" enctype ="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col-md-12"><br>
                                       <label>Title</label>
                                       <input type="text" class="form-control"  name="title" placeholder="Title" value = "{{$rows->title}}" autofocus> 
                                       @if($errors)
                                       @error('title')
                                ...
                                <div class="form-row">
                                    <div class="col-md-12"><br>
                                       ...
                                       <input type="text" class="form-control"  name="publisher" placeholder="Publisher" value = "{{$rows->publisher}}" autofocus> 
                                       @if($errors)
                                       @error('publisher')
                                        <span style = "color:red">{{$message}}</span>
                                       @enderror
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-lg-6" style="float:right">
                                        <img id="userimage" name="userimage" src="{{url('uploads/'.$rows->image)}}" class="img-fluid rounded mr-3" alt="user" width="150px" height="70px" >      
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1">Product Description<span style = "color:red"> (optional)</span></label>
                                     <textarea class='form-control' id='summernote' name  = 'content' rows='5'><?=str_replace('src="','src="'.$root.'/',$rows->content)?></textarea>
                                </div>
                                <br>
                                <div class="form-row">
                                    <div class="col">
                           ...
                           @else
                           <h1 style = "color:red">You are trying to access records that does not exist</h1>
                           @endif
                        </div>
                     </div>
                  </div>

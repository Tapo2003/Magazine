...
<!-- <div class="iq-card" style="box-shadow: none;"> -->
   <img src = "{{url('asset/admin/images/author10.png')}}">
   <!-- <div class="iq-card-header d-flex justify-content-between">
      <div class="iq-header-title">
         <h4 class="card-title" style ="visibility:hidden">Customer Distribution</h4>
      </div>
...
<div class="iq-card" style="box-shadow: none;">
      <img src = "{{url('asset/admin/images/author10.png')}}">
   <div class="iq-card-header d-flex justify-content-between" style ="visibility:hidden">
      <div class="iq-header-title">
         <h4 class="card-title">Project Statistic</h4>
      </div>
   </div>
    <div class="iq-card-body pb-3">
      <ul class="suggestions-lists m-0 p-0" style ="visibility:hidden">
         ...
         <li class="d-flex align-items-center" style ="visibility:hidden">
...
<div class="iq-card" style="box-shadow: none;">
   ...
   <div class="iq-card-body">
      <div class="row">
         <div class="col-lg-12">
            <div class="iq-details" style = "visibility:hidden">
            ...
            <div class="iq-details mt-3">
               <span class="title text-dark" style ="visibility:hidden">India</span>
               <div class="percentage float-right text-warning" style ="visibility:hidden">75 <span>%</span></div>
               <div class="iq-progress-bar-linear d-inline-block w-100" style ="visibility:hidden">
                  <div class="iq-progress-bar">

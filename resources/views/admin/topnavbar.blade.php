...
<div class="iq-navbar-custom">
   <div class="iq-sidebar-logo">
      <div class="top-logo">
         ...
         <img src="{{url('asset/admin/images/logo.gif')}}" class="img-fluid" alt="">
         <span></span>
         </a>
      </div>
   </div>
      ...
      <ul class="navbar-list">
         <li>
            <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center bg-primary rounded">
               ...
               <img src="{{url('asset/admin/images/user/1.jpg')}}" class='img-fluid rounded mr-3' alt='user'>
               ...
               <div class="iq-card shadow-none m-0">
                  <div class="iq-card-body p-0 ">
                     ...
                     <div class="d-inline-block w-100 text-center p-3">
                        <a class="bg-primary iq-sign-btn" href="{{url('signout')}}" role="button">Sign out<i class="ri-login-box-line ml-2"></i></a>
                     </div>
                  </div>
               </div>
            </div>
